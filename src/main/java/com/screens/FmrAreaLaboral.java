...
static Logs log = new Logs();
    ...
    private void Btn_AñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_AñadirActionPerformed
        ...
        log.Logs("PantallaAreaLaboral", "Error al añadir: " + ex);
    ...
    private void Btn_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_ActualizarActionPerformed
        ...
        log.Logs("PantallaAreaLaboral", "Error al editar: " + ex);
    ...
    private void Btn_ActivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_ActivarActionPerformed
        ...
        log.Logs("PantallaAreaLaboral", "Error al desactivar: " + ex);
    ...
    private void Btn_LimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_LimpiarActionPerformed
      try{
        ...
        log.Logs("PantallaAreaLaboral", "Error al limpiar: " + ex);
    ...
    private void Btn_ImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_ImprimirActionPerformed
        ...
        log.Logs("PantallaAreaLaboral", "Error al imprimir reporte: " + ex);
 ...
 private void Activar_Desactivar(){
       ...
       try {
        ...
        log.Logs("PantallaAreaLaboral", "Error al activar: " + ex);
       ...
       private void EditarAreaLaboral(){
        ...
        }else if(Txt_DescripciónÁreaLaboral.getText().length() < 8){
    ...
    private void GenerarReporte(){
        ...
        JasperReport report = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/ReporteAreaLaboral.jasper"));
        ...
        view.setTitle("Reporte Area Laboral");
        Image icon = new ImageIcon(getClass().getResource("/imagenes/IconoMicrocosmos.png")).getImage();
    ...
    String select = "SELECT idPermisos FROM Permisos Where agregarAreaLaboral = true AND idUsuario IN (SELECT idUsuario FROM Usuarios WHERE idEmpleados = '"+ id+ "')";
    ...
    String select = "SELECT idPermisos FROM Permisos Where editarAreaLaboral = true AND idUsuario IN (SELECT idUsuario FROM Usuarios WHERE idEmpleados = '"+ id+ "')";
    ...
    String select = "SELECT idPermisos FROM Permisos Where desactivarAreaLaboral = true AND idUsuario IN (SELECT idUsuario FROM Usuarios WHERE idEmpleados = '"+ id+ "')";
    ...
    String select = "SELECT idPermisos FROM Permisos Where imprimirAreaLaboral = true AND idUsuario IN (SELECT idUsuario FROM Usuarios WHERE idEmpleados = '"+ id+ "')";
