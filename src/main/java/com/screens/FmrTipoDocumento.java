...
public class FmrTipoDocumento extends javax.swing.JFrame {
    ...
    private void Btn_LimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_LimpiarActionPerformed
        ...
        log.Logs("PantallaTipoDocumento", "Error al limpiar: " + ex);
    ...
    private void Btn_AñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_AñadirActionPerformed
      ...
      try{        
        ...
        log.Logs("PantallaTipoDocumento", "Error al añadir: " + ex);
    ...
    private void Btn_EditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_EditarActionPerformed
        ...
        log.Logs("PantallaTipoDocumento", "Error al editar: " + ex);
    ...
    private void Btn_Activar_DesactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_Activar_DesactivarActionPerformed
        ...
        log.Logs("PantallaTipoDocumento", "Error al desactivar: " + ex);
    ...
    private void Btn_ImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_ImprimirActionPerformed
       ...
       try{
        ...
        log.Logs("PantallaTipoDocumento", "Error al generar reporte: " + ex);
    ...
    private void LlenarTipoDocumento(){
        ...
        JOptionPane.showMessageDialog(this, "El nombre tiene que contener mínimo 3 letras","Error",JOptionPane.ERROR_MESSAGE);
       ...
       Btn_Activar_Desactivar.setEnabled(false);
        ...
        log.Logs("PantallaTipoDocumento", "Error al activar: " + ex);
        ...
        JasperReport report = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/ReporteTipoDocumento.jasper"));
    ...
    String select = "SELECT idPermisos FROM Permisos Where agregarTipoDocumento = true AND idUsuario IN (SELECT idUsuario FROM Usuarios WHERE idEmpleados = '"+ id+ "')";
    ...
    String select = "SELECT idPermisos FROM Permisos Where editarTipoDocumento = true AND idUsuario IN (SELECT idUsuario FROM Usuarios WHERE idEmpleados = '"+ id+ "')";
    ...
    String select = "SELECT idPermisos FROM Permisos Where desactivarTipoDocumento = true AND idUsuario IN (SELECT idUsuario FROM Usuarios WHERE idEmpleados = '"+ id+ "')";
    ...
    String select = "SELECT idPermisos FROM Permisos Where imprimirTipoDocumento = true AND idUsuario IN (SELECT idUsuario FROM Usuarios WHERE idEmpleados = '"+ id+ "')";
